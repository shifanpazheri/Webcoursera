...
<div class="container">
 ...
 <h3>Categories: <button type="button" class="btn btn-secondary"><a href="PYTHON_short.php">Short</a></button> <td><a href="PYTHON_long.php"><button type="button" class="btn btn-secondary">Long</a></button> </h3>
