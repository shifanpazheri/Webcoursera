...
<img class="img-responsive" src="AJAX.png" alt="Chania" width="304" height="236" style="vertical-align:middle;margin:0px 350px">
  ...
  <h3>Categories: <button type="button" class="btn btn-secondary"><a href="AJAX_short.html">Short</a></button> <td><a href="AJAX_long.html"><button type="button" class="btn btn-secondary">Long</a></button> </h3>
