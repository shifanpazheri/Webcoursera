...
<div class="container">
  ...
  <h3>Current Category: <td><button type="button" class="btn btn-secondary"><a href="HTML_short.php">Short</a></button></h3>
  <h3>Categories:<td><button type="button" class="btn btn-secondary"><a href="HTML_short.php">Short</a></button> <td><button type="button" class="btn btn-secondary"><a href="HTML_long.php">Long</a> </button></td></h3>
