...
<div class="container">
  ...
  <h3>Current Category: <button type="button" class="btn btn-secondary"><td><a href="HTML_long.php">Long</a> </td></h3></button>
  <h3>Categories: <button type="button" class="btn btn-secondary"><td><a href="HTML_short.php">Short</a></button> <td><button type="button" class="btn btn-secondary"><a href="HTML_long.php">Long</a> </button></td></h3>
