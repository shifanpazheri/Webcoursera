      ...
      <p>
          <div class="input-group" >
            ...
            <span class="input-group-btn">
              <button class="btn btn-default" type="button" style="padding-top: 12px;"><span class="glyphicon glyphicon-search"></span></button>
            </span>
          </div><!-- /input-group -->
       </p>
  </div>
...
<h3>Current Category: <button type="button" class="btn btn-secondary"><a href="JAVASCRIPT_long.php">Long</a></button></h3>
